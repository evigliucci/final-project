...
function DeptPopulate() {
    ...
    if (error) {
        ...
        return(
            ...
            <img src="+" {data.icon} "+" class="mr-3" alt="https://cdn.countryflags.com/thumbs/united-states-of-america/flag-round-250.png"></img>
            <p> {data.mission}</p>
            <p href="+" {data.website} "+">Link to Department Website</p>
